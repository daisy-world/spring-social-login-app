    ...
    <div id="logreg-forms">
        <form class="form-signin" action="/login" method="post">
            ...
            <div class="social-login">
              <a href = "${pageContext.request.contextPath}/facebookLogin">  <button class="btn facebook-btn social-btn" type="button"><span><i class="fab fa-facebook-f"></i> Sign in with Facebook</span> </button></a>
